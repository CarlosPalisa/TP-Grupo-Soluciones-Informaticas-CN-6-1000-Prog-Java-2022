    ...
    public void mostrarMenu() throws SQLException, ParseException {
		...
		System.out.print("------------------------------------------------ \n");
     	...
     	case 4:
     	   	//MOSTRAR PELICULAS
     		peli.getPeliculas();
     		System.out.print("Desea cargar un estreno S/N");
     		String est = t.next();
        ...
        case 5:
        	principal p = new principal();
     		break;
        case 0:
		     System.out.print("HA SALIDO DEL SISTEMA... VUELVA PRONTO...");
		...
		private void subMenuCartelera() throws SQLException, ParseException {
        	System.out.println("------------- Sub - Menu Carteleras -----------------");
    		System.out.print("------------------------------------------------- \n");
    		...
    		System.out.print("------------------------------------------------ \n");
         	...
         	case 3:
         		...
         		System.out.print("Introdusca aqui su eleccion----> ");
         		int del = t.nextInt();
         		if(del==1) {
        ...
        private void subMenuDesc() throws SQLException, ParseException {
        	...
        	System.out.println("------------- Sub - Menu Descuentos -----------------");
    		System.out.print("------------------------------------------------- \n");
