...
public class Cartelera {
	...
	public void formCartelera() throws SQLException, ParseException {
		System.out.println("----------            FORMULARIO DE CREACION DE CARTELERA          ----------------");
		mostrarCarteleras();
		pausa(5000);
		System.out.println("\n");
		...
		pausa(3000);
		System.out.println("Digite 0 p CANCELAR: ");
		System.out.print("Digite la opcion----->: ");
		int peli= t.nextInt();
		
		// VALIDAMOS SI QUIERE CONTINUAR O CANCELAR
		if(peli!=0) {
		     
		     System.out.println("___________________________________________________________________________________");
		     sa.getSala();
		     //SELECIONAMOS LA SALA
